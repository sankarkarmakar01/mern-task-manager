  ...
  return (
    <div className="w-full max-w-sm bg-white/90 backdrop-blur-md border border-sky-100 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <button
          onClick={() => onDelete(id)}
          className="px-4 py-2 border border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded-lg text-sm transition-all duration-200 cursor-pointer"
        >
          Delete
        </button>
      </div>
